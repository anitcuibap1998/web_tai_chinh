...
if (!isset($_SESSION['username'])) {
    ...
    $laiXuat = 3;
    $loaiDauTu = 2; // 1 là đầu tư gold, 2 là đầu tư kim cương 
...
if (isset($_POST['submit'])) {
    ...
    //insert vào db 
    $sql = "INSERT INTO `dau_tu_so`(`phoneGuiTien`, `tenNguoiGui`, `so_tien_dau_tu`, `loai_dau_tu`, `ngay_dau_tu`, `id_user`, `lai_xuat`, `maThanhToan`,`trang_thai`) VALUES ('$phoneGuiTien','$tenNguoiGui','$mucGui','2','$ngayGuiTienDauTu','$idUser','$laiXuat','$maThanhToan','0')";
    // $result = $conn->query($sql);
...
<body>
    ...
    <section class="section main-banner" id="top" data-section="section1">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <form id="form_active_2" action="dau_tu_diamond.php" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="custom-select" name="mucGui" id="mucGui" onchange="getValueSelected(this);" required>
                                <option value="10000000" selected>10.000.000 Vnđ</option>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <img src="momo/momo10tr.png" alt="10tr momo" width="40%" id="qrMoMo" name="qrMoMo">
                        </div>
                    </div>
        ...
        <script>
            function getValueSelected(selectObject) {
                ...
                if (value == 10000000) {
                    qrMoMo.src = "momo/momo10tr.png";
                } else if (value == 20000000) {
                    qrMoMo.src = "momo/momo20tr.png";
                } 
            }
        </script>
    </section>
